...
export const Alert: React.FC<AlertProps> = ({
  ...
  return (
    <div className={`p-4 mb-4 rounded-lg ${typeClasses[type]}`} role="alert">
      <div className="flex items-start">
        ...
        {onClose && (
          <button
            type="button"
            className="ml-auto -mx-1.5 -my-1.5 rounded-lg p-1.5 inline-flex items-center justify-center h-8 w-8 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-transparent"
            onClick={onClose}
            aria-label="Close"
          >
